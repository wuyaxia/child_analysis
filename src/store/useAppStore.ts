...
const presetTasks: Task[] = [
  ...
  { id: 'psc-5e-1', title: '整理房间', description: '收拾自己的房间', category: 'selfcare', difficulty: 'easy', ageRange: { min: 60, max: 71 }, duration: 15, frequency: 'daily', completedDates: [], isCustom: false, createdAt: new Date().toISOString() },
];
