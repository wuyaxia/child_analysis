...
export default async function handler(
  ...
  try {
    ...
    try {
      ...
      if (req.method === 'POST') {
        if (action === 'create') {
          await handleCreateFamily(client, req, res);
        } else if (action === 'join') {
          await handleJoinFamily(client, req, res);
        } else {
          res.status(400).json({ error: 'Invalid action' });
        }
      } else if (req.method === 'GET') {
        if (action === 'family') {
          await handleGetFamily(client, req, res);
        } else if (action === 'members') {
          await handleGetMembers(client, req, res);
        } else if (action === 'member') {
          await handleGetMember(client, req, res);
        } else {
          await handleGetFamily(client, req, res);
        }
      } else if (req.method === 'PUT') {
        await handleUpdateMember(client, req, res);
      } else if (req.method === 'DELETE') {
        await handleLeaveFamily(client, req, res);
      } else {
...
async function handleCreateFamily(client: any, req: VercelRequest, res: VercelResponse) {
...
async function handleJoinFamily(client: any, req: VercelRequest, res: VercelResponse) {
...
async function handleGetFamily(client: any, req: VercelRequest, res: VercelResponse) {
...
async function handleGetMembers(client: any, req: VercelRequest, res: VercelResponse) {
...
async function handleGetMember(client: any, req: VercelRequest, res: VercelResponse) {
...
async function handleUpdateMember(client: any, req: VercelRequest, res: VercelResponse) {
...
async function handleLeaveFamily(client: any, req: VercelRequest, res: VercelResponse) {
